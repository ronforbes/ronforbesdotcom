...
export const metadata: Metadata = {
  title: "Blog",
  description: "Read articles on career, AI, health, VR, personal finance, and happiness.",
};
    ...
    <div className="container py-12 md:py-16">
      <div className="space-y-4 mb-10">
        ...
        <p className="text-xl text-muted-foreground max-w-[700px]">
          Thoughts, insights, and experiences on career development, technology, health, and more.
        </p>
      </div>
      ...
      {posts.length > 0 ? (
        ...
        <div className="text-center py-12 text-muted-foreground">
          <p>No blog posts yet. Add MDX files to the <code className="bg-muted px-2 py-1 rounded text-sm">content/blog</code> directory.</p>
        </div>
      )}
    </div>
  );
